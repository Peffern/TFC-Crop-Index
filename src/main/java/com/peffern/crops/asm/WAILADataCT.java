			...
			if(m.name.equals("getWailaStack") && m.desc.equals("(Lmcp/mobius/waila/api/IWailaDataAccessor;Lmcp/mobius/waila/api/IWailaConfigHandler;)Lnet/minecraft/item/ItemStack;"))
			{
				...
				while(it.hasNext())
				{
					...
					if(insn instanceof MethodInsnNode)
					{
						...
						{
							MethodInsnNode newMinsn = new MethodInsnNode(INVOKESTATIC, "com/peffern/crops/WAILAData", "getWailaStack", "(Lmcp/mobius/waila/api/IWailaDataAccessor;Lmcp/mobius/waila/api/IWailaConfigHandler;)Lnet/minecraft/item/ItemStack;", minsn.itf);
