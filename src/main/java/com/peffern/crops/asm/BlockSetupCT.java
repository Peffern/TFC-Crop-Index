 ...
 * Replaces the BlockCrop setup with the new custom crop block. 
 * @author peffern
 *
 */
			...
			if(m.name.equals("loadBlocks") && m.desc.equals("()V"))
			{
				...
				while(it.hasNext())
				{
					...
					if(insn instanceof TypeInsnNode)
					{
						...
						if(tinsn.desc.equals("com/bioxx/tfc/Blocks/BlockCrop"))
						{
							//replace
							TypeInsnNode newTinsn = new TypeInsnNode(tinsn.getOpcode(), "com/peffern/crops/BlockCustomCrop");
					...
					if(insn instanceof MethodInsnNode)
					{
						...
						if(minsn.owner.equals("com/bioxx/tfc/Blocks/BlockCrop"))
						{
							//replace
							MethodInsnNode newMinsn = new MethodInsnNode(minsn.getOpcode(), "com/peffern/crops/BlockCustomCrop", minsn.name, minsn.desc, minsn.itf);
